...
class AllpointspaymentsTest < Test::Unit::TestCase
  def setup
    Base.mode = :test
    @gateway = AllpointspaymentsGateway.new(:login => 'username', :password => 'password')
  ...
  def test_default_currency
    @gateway.expects(:ssl_post).with(anything, regexp_matches(/CurrencyCode="978"/), anything).returns(successful_visa_no_3d_purchase_response)
      ...
      <soap:Body>
        <CardDetailsTransactionResponse xmlns="https://www.thepaymentgateway.net/">
          ...
          <TransactionOutputData CrossReference="110706093540191601939772">
            ...
            <GatewayEntryPoints>
              <GatewayEntryPoint EntryPointURL="https://gw1.allpointspayments.net:4430/" Metric="100"/>
              <GatewayEntryPoint EntryPointURL="https://gw2.allpointspayments.net:4430/" Metric="200"/>
              <GatewayEntryPoint EntryPointURL="https://gw3.allpointspayments.net:4430/" Metric="300"/>
            </GatewayEntryPoints>
